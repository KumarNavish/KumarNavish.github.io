...
const PROCESS_KEYWORDS: Record<ProcessId, string[]> = {
  access_request: ["access", "permission", "entitlement", "provision", "iam"],
  vendor_onboarding: ["vendor", "supplier", "onboard", "third-party", "procurement"],
  purchase_request: ["purchase", "buy", "spend", "budget", "invoice"],
  incident_escalation: ["incident", "outage", "sev", "escalate", "oncall"],
};
