...
export const WORK_REGISTRY: WorkRegistryEntry[] = [
  {
    ...
    role: "Co-author; contributed to the paired-user dataset, empirical analysis, and interpretation of interaction and linguistic asymmetries.",
  ...
  },
  {
    ...
    role: "Co-author; contributed to the operator definitions, spectral analysis, examples, and exposition.",
  ...
  },
  {
    ...
    type: "paper",
    coauthors: ["M. Rajesh Kannan", "Shivaramakrishna Pragada"],
    role: "Co-author; contributed to the spectral bounds, frustration analysis, constructive arguments, and examples.",
  ...
  },
  {
    ...
    year: 2023,
    venue:
      "NeurIPS 2022 Workshop on Tackling Climate Change with Machine Learning · arXiv:2301.12887",
    ...
    role: "Co-author; contributed to machine-learning modelling, spatial data abstraction, and the translation from urban context to operational decisions.",
  ...
  },
  {
    ...
    statusNote:
      "Public research manuscript on arXiv; no published venue is claimed.",
    experienceStatus: "full-interactive-chapter",
    ...
    role: "Lead author; developed the optimization perspective, theoretical analysis, experiments, and manuscript with collaborators.",
  ...
  },
  {
    ...
    role: "Lead author; formulated replay as constrained correction matching, developed the diagnostics and method, and led the experimental and rebuttal work.",
    ...
    metadata: {
      title:
        "Experience Replay Through the Lens of Optimization | Navish Kumar",
      description:
  ...
  },
  {
    ...
    type: "paper",
    coauthors: ["Aurelien Lucchi"],
    role: "Lead author; developed the geometric feasibility formulation, minimum-norm correction, rank diagnostic, and empirical evaluation.",
  ...
  },
  {
    ...
    title:
      "Counterfactual Window Replay for Time-Continual Language Model Pretraining",
    ...
    type: "experiment",
    coauthors: [],
    role: "Research lead; developing the counterfactual token-allocation objective, temporal diagnostics, and planned empirical protocol.",
  ...
  },
  {
    ...
    type: "system",
    coauthors: [],
    role: "Product and research lead; designed the interaction model, deterministic authority boundaries, typed process-evidence substrate, verification, replay, and deployment architecture.",
  ...
  },
  {
    ...
    type: "direction",
    coauthors: [],
    role: "Product and research direction; designed and implemented the persistent language-to-world interaction, typed scene state, direct manipulation, and situated action loop.",
...
export const WORK_BY_ROUTE = new Map(
  WORK_REGISTRY.map((work) => [work.route, work]),
);
