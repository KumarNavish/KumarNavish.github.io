...
export const ARC_STEPS: ArcStep[] = [
  {
    ...
    purpose: 'Define the operational pressure before selecting methods.',
    question: 'Which decisions must remain reliable as conditions change?',
    evidence: 'Problem framing and operating constraints.',
  ...
  },
  {
    ...
    question: 'Do the methods stay stable as data and regimes shift?',
